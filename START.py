                ...
                for line in f:
                    ...
                    if line and not line.startswith('#'):
                        if '=' in line:
                            ...
                            if key in ('OPENAI_API_KEY', 'VITE_OPENAI_API_KEY') and not API_KEY:
                                API_KEY = value.strip().strip('"')
                            elif key in ('OPENAI_API_ENDPOINT', 'VITE_OPENAI_API_ENDPOINT'):
                                API_ENDPOINT = value.strip().strip('"')
                            elif key in ('OPENAI_MODEL', 'VITE_OPENAI_MODEL'):
                                API_MODEL = value.strip().strip('"')
